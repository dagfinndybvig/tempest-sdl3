...
An experimental 3D vector-style engine built with C and SDL1, compiled to WebAssembly via Emscripten. This project is inspired by *Tempest*, the classic 1980s arcade game named after Shakespeare's play *The Tempest*, which features the wizard Prospero.
